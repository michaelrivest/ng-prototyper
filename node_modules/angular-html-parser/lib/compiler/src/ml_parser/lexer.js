...
(function (TokenType) {
    ...
    TokenType[TokenType["DOC_TYPE_START"] = 13] = "DOC_TYPE_START";
    TokenType[TokenType["DOC_TYPE_END"] = 14] = "DOC_TYPE_END";
...
function tokenize(source, url, getTagDefinition, tokenizeExpansionForms = false, interpolationConfig = interpolation_config_1.DEFAULT_INTERPOLATION_CONFIG, canSelfClose = false, allowHtmComponentClosingTags = false) {
    return new _Tokenizer(new parse_util_1.ParseSourceFile(source, url), getTagDefinition, tokenizeExpansionForms, interpolationConfig, canSelfClose, allowHtmComponentClosingTags)
        .tokenize();
}
...
class _Tokenizer {
     ...
     */
    constructor(_file, _getTagDefinition, _tokenizeIcu, _interpolationConfig = interpolation_config_1.DEFAULT_INTERPOLATION_CONFIG, canSelfClose = false, allowHtmComponentClosingTags = false) {
        this._file = _file;
