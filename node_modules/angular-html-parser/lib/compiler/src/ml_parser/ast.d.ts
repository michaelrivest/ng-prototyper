...
export declare class Attribute implements Node {
    ...
    constructor(name: string, value: string, sourceSpan: ParseSourceSpan, valueSpan?: ParseSourceSpan | null, nameSpan?: ParseSourceSpan | null);
    visit(visitor: Visitor, context: any): any;
}
export declare class Element implements Node {
    ...
    nameSpan: ParseSourceSpan | null;
    constructor(name: string, attrs: Attribute[], children: Node[], sourceSpan: ParseSourceSpan, startSourceSpan?: ParseSourceSpan | null, endSourceSpan?: ParseSourceSpan | null, nameSpan?: ParseSourceSpan | null);
    visit(visitor: Visitor, context: any): any;
}
