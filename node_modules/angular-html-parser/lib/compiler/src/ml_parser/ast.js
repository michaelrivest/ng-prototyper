...
class Attribute {
    constructor(name, value, sourceSpan, valueSpan = null, nameSpan = null) {
        this.name = name;
        this.value = value;
        this.sourceSpan = sourceSpan;
...
class Element {
    constructor(name, attrs, children, sourceSpan, startSourceSpan = null, endSourceSpan = null, nameSpan = null) {
        this.name = name;
        this.attrs = attrs;
