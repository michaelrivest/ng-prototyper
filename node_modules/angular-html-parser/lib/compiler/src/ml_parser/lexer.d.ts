...
export declare function tokenize(source: string, url: string, getTagDefinition: (tagName: string) => TagDefinition, tokenizeExpansionForms?: boolean, interpolationConfig?: InterpolationConfig, canSelfClose?: boolean, allowHtmComponentClosingTags?: boolean): TokenizeResult;
