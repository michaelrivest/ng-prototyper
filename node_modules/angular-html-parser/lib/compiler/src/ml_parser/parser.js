...
class Parser {
    ...
    parse(source, url, parseExpansionForms = false, interpolationConfig = interpolation_config_1.DEFAULT_INTERPOLATION_CONFIG, canSelfClose = false, allowHtmComponentClosingTags = false, isTagNameCaseSensitive = false) {
        const getTagDefinition = isTagNameCaseSensitive ? this.getTagDefinition : (tagName) => this.getTagDefinition(tagName.toLowerCase());
        const tokensAndErrors = lex.tokenize(source, url, getTagDefinition, parseExpansionForms, interpolationConfig, canSelfClose, allowHtmComponentClosingTags);
